                        ...
                        <form method='POST' action='/patients'>
                            ...
                            <div class='row'>
                                ...
                                <div class='form-group col-lg-6'>
                                    ...
                                    <input type='tel' class='form-control' name='phone_number' value='{{ $patient->phone_number }}'/>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <div class='form-group col-lg-6'>
                                    ...
                                    <input type='tel' class='form-control' name='emergency_contact_phone_number' value='{{ $patient->emergency_contact_phone_number }}'/>
                                </div>
                            </div>
